          ...
          {!showNewCategory ? (
            ...
            <div className="flex gap-2 mt-2">
              <input
                ...
                className="flex-1 px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none bg-white text-gray-900"
              />
              <button
                type="button"
